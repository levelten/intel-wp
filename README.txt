...
= 1.2.2 =
* Added help JumpStart videos
* Extended demo: form settings and shortcode editing
* Redirect tracking via cookies
...
= 1.2.6 =
* Push Intelligence events & goals to base profile
* Sync Intelligence goal management to base profile
