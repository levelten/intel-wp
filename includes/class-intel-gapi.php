...
if ( ! class_exists( 'Intel_GAPI_Controller' ) ) {

	final class Intel_GAPI_Controller {
		...
		public function __construct() {
			...
			//include_once ( INTEL_DIR . 'intel.autoload.inc' );
...
<?php
		...
		public function handle_corereports( $projectId, $from, $to, $metrics, $options, $serial ) {
			try {
				if ( $from == "today" ) {
					$timeouts = 0;
				} else {
